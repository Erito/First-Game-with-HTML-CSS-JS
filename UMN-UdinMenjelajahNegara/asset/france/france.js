...
document.addEventListener("DOMContentLoaded", function () {
    ...
    button.addEventListener("click", function () {
        ...
        setTimeout(() => {
            alert("Kamu sedang masuk kedalam Université de Strasbourg dan foto fasilitas yang ada didalam");
            checkQuestCompletion("fotoFrance");
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const foods = [
        {nama:"Escargot", cost:"$5", harga: 5, addBar:50},
        {nama:"Ratatouille", cost:"$2", harga:2 , addBar:20},
        {nama:"Coq au Vin", cost:"$3", harga:3, addBar:30}
    ]
    ...
    foods.forEach(food => {
        ...
        foodButton.addEventListener("click", function () {
            ...
            setTimeout(() => {
                ...
                checkQuestCompletion("makanFrance");
